...
class ArticlesController extends Controller{
    ...
    public function read(){
        ...
        if ( isset($params[0]) ){
            ...
            $total = $this->CommentModel->getCountCommentsByNews($id);
